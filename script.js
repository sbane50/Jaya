...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "Jaya, a few words to describe how I fee every time I see you...",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      ...
      context.fillText(
        "Agape: (n.) the highest form of love, which persists no matter the circumstance",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 2700 && frameNumber < 3000) {
    ...
    if (window.innerWidth < 600) {
      ...
      context.fillText(
        "I want to hold you in my arms, be with you until death",
        canvas.width / 2,
        canvas.height / 2
      );
    }
